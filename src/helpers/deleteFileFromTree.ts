import type { FolderNode, ProjectRootNode } from './tree'

const deleteFileFromTree = (
  tree: ProjectRootNode,
  fileToDelete: string,
): ProjectRootNode => deleteFileFromProjectRootOrFolder(tree, fileToDelete)

const deleteFileFromProjectRootOrFolder = <
  T extends FolderNode | ProjectRootNode,
>(
  folder: T,
  fileToDelete: string,
): T => {
